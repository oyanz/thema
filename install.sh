...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]                  LICENSY OYANZ                  [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "oyanz" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke yanti${NC}"
    echo -e "${YELLOW}TELEGRAM : @yanti${NC}"
    echo -e "${YELLOW}WHATSAPP : 6283120975728${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©yantiOffc${NC}"
    exit 1
  fi
  clear
}
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/oyanz/thema/raw/main/C2.zip")
        break
        ;;
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/oyanz/thema/raw/main/C3.zip")
        break
        ;; 
      x)
        return
...
# Unduh file tema
wget -O /root/C2.zip https://github.com/oyanz/thema/raw/main/C2.zip
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer Oyanz     ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : yanti      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : yantiOFFC  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by Oyanz        ${NC}"
